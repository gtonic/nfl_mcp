            ...
            async def mock_fetch_athletes():
                try:
                    ...
                    return {
                        ...
                        "last_updated": None,
                        "success": False,
                        "error": f"Unexpected error fetching athletes: {e!s}"
                    }
        ...
        def mock_lookup_athlete(athlete_id: str):
            try:
                ...
                return {
                    "athlete": None,
                    "found": False,
                    "error": f"Error looking up athlete: {e!s}"
                }
        ...
        def mock_search_athletes(name: str, limit: int = 10):
            try:
                ...
                return {
                    ...
                    "count": 0,
                    "search_term": name,
                    "error": f"Error searching athletes: {e!s}"
                }
        ...
        def mock_get_athletes_by_team(team_id: str):
            try:
                ...
                return {
                    ...
                    "count": 0,
                    "team_id": team_id,
                    "error": f"Error getting athletes for team: {e!s}"
                }
